...
def run_alert(alert):
    ...
    try:
        ...
        for email, group in grouped:
            ...
            # ✅ UPDATED HTML BODY (CLIENT ALERT)
            body = f"""
<html>
...
<p>
Our monitoring system has detected <b>{total_cases}</b> court case(s) related to your entity.
</p>

<p>
<b>Entity Name:</b> {entity_name}
</p>

<p>
Please find attached the detailed case report.
</p>

<p>
Source: <a href="https://judgments.ecourts.gov.in/">eCourts</a>
</p>
...
<p>
Regards,<br>
<b>Compliance Monitoring System</b>
</p>
...
"""
        ...
        for _, row in company_df.iterrows():
            ...
            # ✅ UPDATED HTML BODY (COMPANY REPORT)
            body = f"""
<html>
...
<h2 style="color:#2c3e50;">Daily Litigation Intelligence Report</h2>
...
This is an automated email from Compliance Monitoring System.
</p>
